...
signalFraction = seq(.2, .8, length.out=4)
ngenes_array = c(round(seq(50, 150, length.out=3), 0), 200, 300, 500, 1000)
...
# method="pseu"
res1 = mvBIC_fit( t(scale(Y)), ~ X_1, X, logDetMethod=method, lambda=0.317)
res1@params
res2 = mvBIC_fit( t(scale(Y)), ~ 1, X, logDetMethod=method, lambda=0.317)
res2@params
res1-res2
...
d1 = svd(residMatrix1)$d^2 + .1
d2 = svd(residMatrix2)$d^2 + .1
# plot(d1, d2, log="xy")
