...
with high signam, why do other perform better?  Is that an issue with the randomization of the simulations???fgte
...
signalFraction = seq(.4, .8, by=.2)
ngenes_array = c(10, 20, 40, 60, 80, 100)#, 200, 500)
rho_array = seq(0, .98, length.out=9)
