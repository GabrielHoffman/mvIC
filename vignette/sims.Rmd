...
signalFraction = .3 #seq(.2, .8, by=.1)
ngenes_array = c(10, 30, 50)#c(round(seq(10, 100, length.out=5), 0), 200, 500)
    ...
    resRecovery = lapply(ngenes_array, function(p){
        ...
        resRecovery = lapply( rho_array, function(rho){
          ...
          resRecovery = lapply(signalFraction, function(sigFrac){
            ...
            methods = c( "Touloumis_unequal", "Touloumis_equal", "pseudodet")  #"Strimmer" 
