...
n = 100 # number of samples
m_active_array = 1#:3
signalFraction = seq(.5, .8, length.out=3)
ngenes_array = c(5,10, 20, 50, 100, 200)#, 25, 30, 40, 50)
rho_array = seq(.01, .25, length.out=5)
...
optimize( logML, lower=0, upper=1, X=X, target=target, alpha)
